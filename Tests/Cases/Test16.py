# TEST 16
# Test that calls 'vdot.py' program with three existent data files. The
# files meet the following requirements:
#   - files have even vector component count;
#   - files store values that follow numeric value syntax except the third
#     file that contains non-numeric characters;
...
IN_NAME2 = "even_com_scient2.dat"
IN_NAME3 = "even_com_nnum_scient.dat"
IN_DIR = "Inputs/"
