# TEST 17
# Test that calls 'vdot.py' program with three data files. The files meet
# the following requirements:
#   - the first file does not exist;
#   The rest of the files:
#   - have even vector component count;
#   - store values that follow numeric value syntax;
#   - files may contain numbers that are written in scientific notation;
...
IN_NAME1 = "vec.dat"
IN_NAME2 = "even_com_scient1.dat"
IN_NAME3 = "even_num_com_eln1.dat"
IN_DIR = "Inputs/"
