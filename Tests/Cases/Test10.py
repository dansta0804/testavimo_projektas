...
# contains numeric values that are expressed in scientific notation. The
# program is supposed to handle such values without any warnings.
#   - data file contains no comments;
#   - data file contains no empty lines.

import os
from pathlib import Path
from vdot import handle_input

IN_NAME = "ncom_scient.dat"
IN_DIR = "Inputs/"
